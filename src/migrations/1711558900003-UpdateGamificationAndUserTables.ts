...
export class UpdateGamificationAndUserTables1711558900003 implements MigrationInterface {
    name = 'UpdateGamificationAndUserTables1711558900003'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            ALTER TABLE "gamification_missions"
            ADD CONSTRAINT "FK_gamification_missions_mission"
