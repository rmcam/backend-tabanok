import { Entity, PrimaryGeneratedColumn, PrimaryColumn, Column, ManyToOne, JoinColumn, ManyToMany, JoinTable, OneToMany, Unique } from 'typeorm';
...
export class Content {
  ...
  mappingId?: string; // Para almacenar el ID del JSON de mapeo
  ...
  @Column({ type: 'simple-array', nullable: true, name: 'vocabulary_keywords' })
  ...
  @ManyToMany(() => Lesson, lesson => lesson.contents)
  lessons: Lesson[];
}
