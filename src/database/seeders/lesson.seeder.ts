...
export class LessonSeeder extends DataSourceAwareSeed {
  ...
  async run(): Promise<void> {
    ...
    const sectionToUnityMap: { [key: string]: string } = {
      ...
      Alfabeto: 'El Alfabeto Kamëntsá Completo',
      ArticulacionDetallada: 'Articulación de Sonidos Específicos',
      CombinacionesSonoras: 'Grupos Consonánticos y Reglas de Unión',
      Consonantes: 'Sistema Consonántico Kamëntsá',
      Numero: 'Número en Sustantivos Kamëntsá',
      PatronesAcentuacion: 'Acentuación y Ritmo del Idioma',
      Pronombres: 'Pronombres Personales Kamëntsá',
      Pronunciacion: 'Guía Completa de Pronunciación',
      Sustantivos: 'Sustantivos: Radical y Clasificador',
      VariacionesDialectales: 'Variaciones Regionales del Kamëntsá',
      Verbos: 'Verbos: Tipos y Conjugaciones',
      Vocales: 'Sistema Vocálico Kamëntsá',
      ClasificadoresNominales: 'Clasificadores Nominales Detallados',
    };
    ...
    lessonsToSeed.push(
        { title: 'Verbos Irregulares', description: 'Lección sobre los verbos irregulares en Kamëntsá.', unityTitle: 'Verbos: Tipos y Conjugaciones' },
        ...
        { title: 'Fonemas Especiales', description: 'Lección sobre sonidos y fonemas particulares del Kamëntsá.', unityTitle: 'Articulación de Sonidos Específicos' },
