...
*   **Testing:**
    ...
    - Los tests unitarios para `auth.service.spec.ts` han sido corregidos y ahora pasan. Se ha implementado la verificación de tokens de refresco revocados. Se han añadido pruebas para el guard `JwtAuthGuard` y ahora prioriza el token del header sobre el de las cookies.
*   **Despliegue:**
...
Última actualización: 20/5/2025, 4:54 p.m. (America/Bogota, UTC-5:00)
